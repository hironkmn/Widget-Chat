...
function addMessage(data, message) {
    ...
    tchat.insertAdjacentHTML('beforeend', /*html*/`<div id="message-${data.msgId}" data-sender="${data.userId}" class="message"
    style="--color: ${color}">
        <div class="meta">
            <div class="badges">${badges}</div>
            <div class="name" data-name=${data.displayName}>${data.displayName}</div>
        </div>
        <div class="content">
        ${message}
        </div>
